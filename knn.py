...
# knn5 = KNeighborsClassifier(n_neighbors=5,metric='chebyshev')
# knn7 = KNeighborsClassifier(n_neighbors=7,metric='chebyshev')
# knn9 = KNeighborsClassifier(n_neighbors=9,metric='chebyshev')
...
# print("Accuracy with k=3", accuracy_score(y_test, y_pred_3))
...
# print("F1-Score with k=1", f1_score(y_test, y_pred_3))
